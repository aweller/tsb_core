...
class IRApiUtilities:
    ...
    def get_variome(self,analysis_id,token,analysis_base_url,variome_base_url,output_dir, analysis_ir_version):
...
#         print "------------------------------------------------------"
        ...
        if(analysis_zipfile != 0):
            print "fetching", (analysis_id,token,analysis_base_url,output_dir)
            ...
            try:
                ...
                try:
                    ...
                    chp_version_no = rows[3][4].split("v")[1][0]
                    self.chp_version = "_CHP" + chp_version_no
            ...
            if(variome_zipfile != 0):
                ...
                filename_extension = self.chp_version+"_"+analysis_ir_version.upper()
#                 filename_extension = "_"+analysis_ir_version.upper()
...
#                 print "variome_zipfile error"
            ...
            #reset class variables     
#             print "failed to download zipfile", (analysis_id,token,analysis_base_url,output_dir)   
            self.container_id = None
            self.sample_T_id = None
            self.sample_N_id = None 
            return 0  
...
#             print 'Completed file download %s' % zip_filename
